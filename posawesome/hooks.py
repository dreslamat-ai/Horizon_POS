...
app_name = "posawesome"
app_title = "Horizon POS"
app_publisher = "Youssef Restom"
app_description = "Horizon POS"
...
# ترحيل Vue3/Vuetify3 (١٧ سبتمبر ٢٠٢٦): Vue وVuetify بقوا مُضمَّنين
# جوه posawesome.bundle.js نفسه (esbuild)، فسكربتَي UMD الكلاسيكيين
# القدام (vue.min.js وvuetify/dist/vuetify.js لـVue2/Vuetify2) اتشالوا
# نهائيًا — تحميلهم كان بيعارض نسخة Vue3 المُضمَّنة في الحزمة.
app_include_css = [
    "/assets/posawesome/node_modules/vuetify/dist/vuetify.css",
    # خط Tajawal — هوية Horizon المعتمدة (راجع posapp.js لألوان الثيم
    # المطابقة من بروتوتايب كاشير سترة). كان الملف موجودًا بالفعل
    # (font.css) لكن غير مربوط هنا، فما كانش يوصل للمتصفح إطلاقًا.
...
app_include_js = [
    ...
    # وجودها (`typeof qz === "undefined"`) قبل أي طباعة حرارية. كانت
    # موجودة كملف على القرص (public/js/vendor/qz-tray.js) بلا أي include
    # فعلي — فالفحص كان بيرجع "غير مثبّت" دايمًا بصرف النظر عن جهاز
    # الكاشير. لازم تتحمّل قبل bundle.js.
    "/assets/posawesome/js/vendor/qz-tray.js",
